    ...
    switch (trecho) {
        ...
        case "trecho3":
            return [                
                ...
                { id: 14, name: "Missing Word", path: `/Atividades/Missing Word2/index.html?level=${level}&unit=${unit}&fase=14`, img: "../../imagens/botoes/missing_word_button.png", unlocked: false },
