document.addEventListener('DOMContentLoaded', function() {
    ...
    const activities = [
        ...
        { id: 1002, name: "QUIZ_IMAGE", path: `/Atividades/QUIZ_IMAGE/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1002`, img: "../../imagens/botoes/quiz_button.png", unlocked: false },
