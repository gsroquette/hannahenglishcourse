    ...
    switch (trecho) {
        ...
        case "trecho4":
            return [
                ...
                { id: 24, name: "Speak3", path: `/Atividades/Speak3/index.html?level=${level}&unit=${unit}&fase=24`, img: "../../imagens/botoes/speak_button.png", unlocked: false },
                { id: 24, name: "Perguntas Starter7", path: `/Atividades/perguntas%20starter7/index.html?level=${level}&unit=${unit}&fase=24`, img: "../../imagens/botoes/hannah_exercises.png", unlocked: false },
            ];
        case "trecho5":
            return [
                ...
                { id: 26, name: "Perguntas Starter8", path: `/Atividades/perguntas%20starter8/index.html?level=${level}&unit=${unit}&fase=26`, img: "../../imagens/botoes/hannah_exercises.png", unlocked: false },
                ...
                { id: 28, name: "Perguntas Starter9", path: `/Atividades/perguntas%20starter9/index.html?level=${level}&unit=${unit}&fase=28`, img: "../../imagens/botoes/hannah_exercises.png", unlocked: false },
