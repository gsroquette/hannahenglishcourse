...
function getActivitiesByTrecho(trecho, level, unit) {
    switch (trecho) {
        ...
        case "trecho6":      
            return [                
                { id: 29, name: "Perguntas Starter11", path: `/Atividades/perguntas%20starter/review.html?level=${level}&unit=${unit}&fase=29`, img: "../../imagens/botoes/review_button.png", unlocked: false },
