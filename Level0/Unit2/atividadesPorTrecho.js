...
function getActivitiesByTrecho(trecho, level, unit) {
    switch (trecho) {
        ...
        case "trecho6":      
            return [
                { id: 29, name: "Perguntas Starter10", path: `/Atividades/perguntas%20starter/review_aleatorio.html?level=${level}&unit=${unit}&fase=29`, img: "../../imagens/botoes/hannah_exercises.png", unlocked: false },
                { id: 30, name: "Perguntas Starter11", path: `/Atividades/perguntas%20starter/review.html?level=${level}&unit=${unit}&fase=30`, img: "../../imagens/botoes/hannah_exercises.png", unlocked: false },
