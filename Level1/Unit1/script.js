document.addEventListener('DOMContentLoaded', function() {
    ...
    const activities = [
        ...
        { id: 1006, name: "LEX", path: `/Atividades/REX/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1006`, img: "../../imagens/botoes/fillintheblanks_button.png", unlocked: false },
    ];
