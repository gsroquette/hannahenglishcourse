document.addEventListener('DOMContentLoaded', function() {
    ...
    const activities = [
        ...
        { id: 17, name: "Flashcards3", path: "../Unit1/Flashcards3/index.html?fase=1", img: "../../imagens/botoes/flashcards_button.png", unlocked: false },
        { id: 18, name: "QUIZ", path: "../Unit1/QUIZ/index.html?fase=18", img: "../../imagens/botoes/quiz_button.png", unlocked: false }
    ];
