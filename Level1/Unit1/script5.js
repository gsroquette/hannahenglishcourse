document.addEventListener('DOMContentLoaded', function() {
    ...
    const activities = [
        ...
        { id: 24, name: "Mixed Letters FIXO3", path: "../Unit1/Mixed Letters FIXO3/index.html?fase=24", img: "../../imagens/botoes/mixed_letters_students.png", unlocked: false },
        { id: 25, name: "Missing Word3", path: "../Unit1/Missing Word3/index.html?fase=25", img: "../../imagens/botoes/missing_word_button.png", unlocked: false },
