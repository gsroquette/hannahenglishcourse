document.addEventListener('DOMContentLoaded', function() {
    ...
    const activities = [
        ...
        { id: 1005, name: "Exerciciosdegramatica", path: `/Atividades/Exerciciosdegramatica/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1005`, img: "../../imagens/botoes/grammar_button.png", unlocked: false },
        { id: 1006, name: "Fill in the Blanks", path: `/Atividades/Fill%20in%20the%20Blanks/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1006`, img: "../../imagens/botoes/fillintheblanks_button.png", unlocked: false },
