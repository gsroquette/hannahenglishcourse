document.addEventListener('DOMContentLoaded', function() {
  ...
  const activities1 = [
    ...
    { id: 4, name: "Flashcards3", path: `/Atividades/Flashcards3/index.html?level=${currentLevel}&unit=${currentUnit}&fase=4`, img: "../../imagens/botoes/flashcards_button.png", unlocked: false },
