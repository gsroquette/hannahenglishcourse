document.addEventListener('DOMContentLoaded', function() {
   ...
   const activities = [
    { id: 1054, name: "Missing Word", path: `/Atividades/Missing Word/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1054`, img: "../../imagens/botoes/missing_word_button.png", unlocked: false },
    { id: 1055, name: "Missing Word2", path: `/Atividades/Missing Word2/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1055`, img: "../../imagens/botoes/missing_word_button.png", unlocked: false },
    { id: 1056, name: "Missing Word3", path: `/Atividades/Missing Word3/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1056`, img: "../../imagens/botoes/missing_word_button.png", unlocked: false },
    { id: 1057, name: "Mixed Letters FIXO", path: `/Atividades/Mixed Letters FIXO/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1057`, img: "../../imagens/botoes/mixed_letters_students.png", unlocked: false },
    { id: 1058, name: "Mixed Letters FIXO2", path: `/Atividades/Mixed Letters FIXO2/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1058`, img: "../../imagens/botoes/mixed_letters_students.png", unlocked: false },
    { id: 1059, name: "Mixed Letters FIXO3", path: `/Atividades/Mixed Letters FIXO3/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1059`, img: "../../imagens/botoes/mixed_letters_students.png", unlocked: false },
];
