...
const activities = [
    { id: 1060, name: "Grammar3", path: `/Atividades/Grammar3/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1060`, img: "../../imagens/botoes/grammar_button.png", unlocked: false },
    { id: 1061, name: "Exerciciosdegramatica3", path: `/Atividades/Exerciciosdegramatica3/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1061`, img: "../../imagens/botoes/exercises_button.png", unlocked: false },
    { id: 1062, name: "GrammarDialogo", path: `/Atividades/GrammarDialogo/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1062`, img: "../../imagens/botoes/conversation_button.png", unlocked: false },
    { id: 1063, name: "QUIZ2", path: `/Atividades/QUIZ2/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1063`, img: "../../imagens/botoes/quiz_button.png", unlocked: false },
    { id: 1064, name: "Diálogo", path: `/Atividades/Dialogo/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1064`, img: "../../imagens/botoes/dialogo_button.png", unlocked: false },
    { id: 1065, name: "Speak", path: `/Atividades/Speak/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1065`, img: "../../imagens/botoes/speak_button.png", unlocked: false },
    { id: 1066, name: "Speak2", path: `/Atividades/Speak2/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1066`, img: "../../imagens/botoes/speak_button.png", unlocked: false },
    { id: 1067, name: "Speak3", path: `/Atividades/Speak3/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1067`, img: "../../imagens/botoes/speak_button.png", unlocked: false },
];
