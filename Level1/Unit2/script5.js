...
const activities = [
    { id: 21, name: "DataGrammar2", path: `/Atividades/DataGrammar2/index.html?level=${currentLevel}&unit=${currentUnit}&fase=21`, img: "../../imagens/botoes/grammar_button.png", unlocked: false },
