document.addEventListener('DOMContentLoaded', function() {
  ...
  const activities = [
    { id: 1068, name: "Hannah Video", path: `/Atividades/HannahVideo/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1068`, img: "../../imagens/botoes/video_button.png", unlocked: false },
    { id: 1069, name: "MatchingGame", path: `/Atividades/MatchingGame/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1069`, img: "../../imagens/botoes/matching_game_button.png", unlocked: false },
    { id: 1070, name: "LifeLessons", path: `/Atividades/LifeLessons/index.html?level=${currentLevel}&unit=${currentUnit}&fase=1070`, img: "../../imagens/botoes/life_lessons_button.png", unlocked: false },
];
